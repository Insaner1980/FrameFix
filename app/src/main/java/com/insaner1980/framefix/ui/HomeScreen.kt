...
@Composable
fun HomeScreen(onImageSelect: (Uri) -> Unit, modifier: Modifier = Modifier) {
    ...
    Box(
        modifier = modifier
            .fillMaxSize()
            .background(FrameFixColors.Background), // Clean Minimalism Dark Charcoal Background
    ) {
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Text(
                ...
                color = FrameFixColors.Muted, // Clean Minimalism Muted Grey
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(
                    containerColor = FrameFixColors.Accent, // Clean Minimalism Sky Blue Accent
                    contentColor = FrameFixColors.Background, // Contrast Dark Charcoal
                ),
                modifier = Modifier
                    .widthIn(min = 220.dp)
                    .height(56.dp)
    ...
    Canvas(modifier = modifier) {
        ...
        drawCircle(
            brush = Brush.radialGradient(
                colors = listOf(FrameFixColors.Accent.copy(alpha = 0.4f), Color.Transparent),
